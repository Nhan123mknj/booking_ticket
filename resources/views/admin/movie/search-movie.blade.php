...
@section('content_Admin')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="card">
        <h5 class="card-header"> <form action="{{ route('searchMovie1') }}" method="POST" class="search-bar">
            @csrf
            <div class="search">
                <button type="submit" name="search_movie"><span class="search-icon material-symbols-outlined">search</span>
                </button>
                <input name="keyword_submit1" type="search" class="search-input" placeholder="Type to Search...">
              </div>
          </form> </h5>
