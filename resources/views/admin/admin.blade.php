...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="source/admin/assets/img/favicon/favicon.ico" />
    ...
    <link rel="stylesheet" href="source/admin/assets/vendor/fonts/boxicons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="source/admin/assets/vendor/css/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="source/admin/assets/vendor/css/theme-default.css" class="template-customizer-theme-css" />
    ...
    <link rel="stylesheet" href="source/admin/assets/search.css">

    <!-- Helpers -->
    <script src="source/admin/assets/vendor/js/helpers.js"></script>
...
"
  ...
  <body>
    ...
    <script src="source/admin/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="source/admin/assets/vendor/libs/popper/popper.js"></script>
    <script src="source/admin/assets/vendor/js/bootstrap.js"></script>
    <script src="source/admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>

    <script src="source/admin/assets/vendor/js/menu.js"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="source/admin/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="source/admin/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="source/admin/assets/js/dashboards-analytics.js"></script>
    ...
    <script>
        var ctx = document.getElementById('bookingsByDateRangeChart').getContext('2d');
        ...
        // Submit form và gửi yêu cầu Ajax để lấy dữ liệu thống kê
        document.getElementById('dateRangeForm').addEventListener('submit', function(event) {
            ...
            fetch('admin/statistics/bookings-by-date-range', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    myChart.data.datasets[0].data = data.map(item => item.count);
                    myChart.update();
                });
        });
    </script>
