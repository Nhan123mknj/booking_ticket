	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action='{{ route('post-login') }}' method="POST" class="login100-form validate-form">
                    @csrf
                    ...
                    @if ($errors->has('email'))
                    <div style="color: red; font-size: 13px;">{{ $errors->first('email') }}</div>
                @endif
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="{{ route('dang-ky') }}">
							Tạo tài khoản
