    ...
    <div class="container-fluid">
                    ...
                    <div id="dl-menu" class="xv-menuwrapper responsive-menu">
                        ...
                        <ul class="dl-menu">
                            @foreach ($menus as $menu)
                                <li class="parent"><a href="{{ route($menu->slug) }}">{{ $menu->MenuName }}</a>
                                    @if($menu->subMenus->count() > 0)
                                    <ul class="lg-submenu">
                                        @foreach ($menu->submenus as $submenu)
                                            <li><a href="{{ route($submenu->slug) }}">{{ $submenu->MenuName }}</a></li>
                                        @endforeach
                                    </ul>
                                    @endif
                                </li>
                            ...
                            <li class="parent megamenu"><a href="{{ route('blog') }}">Blog</a>
        ...
        <div class="prs_navi_right_main_wrapper">
            ...
            <div class="prs_top_login_btn_wrapper">
                <div class="prs_animate_btn1">
                    <ul>
                        @if (Auth::check())
                            <li>
                                <a href="{{ route('logout') }}" class="button button--tamaya" data-text="Đăng xuất" data-toggle="modal"><span>Đăng Xuất</span></a>
                            </li>
                        @else
                            <li>
                                <a href="{{ route('dang-nhap') }}" class="button button--tamaya" data-text="Đăng nhập" data-toggle="modal"><span>Đăng nhập</span></a>
                            </li>
                        @endif
                    </ul>
                </div>
            ...
            <div class="product-heading">
                ...
                padding: 20px;
                color: #fff;
            "><i class="fa-solid fa-user"></i>  Xin chào, {{ Auth::user()->name }}</h4>
                 @else
                            <h1></h1>
                 @endif
            ...
            <g>
                ...
                <div class="prs_top_login_btn_wrapper prs_slidebar_searchbar_btn_wrapper">
                    <div class="prs_animate_btn1">
                        ...
                        @endif
                            {{-- <li><a href="#" class="button button--tamaya" data-text="sign up" data-toggle="modal" data-target="#myModal"><span>Đăng nhập</span></a>
                            </li> --}}
                        </ul>
                    </div>
                </div>
